...
class Map_controller
{
    public static function generateMap($rows = 10, $cols = 13)
    {
        ...
        $biomes = ['w1', 'w2', 'w3', 'r1', 'r2', 'r3', 'm1', 'm2', 'm3', 'de1', 'de2', "s1", "s2"]; //bosque rio montaña desierto pantano

        //Creo biomas aleatorios
        for ($i = 0; $i < $rows; $i++) {
            for ($j = 0; $j < $cols; $j++) {
                $map[$i][$j] = $biomes[mt_rand(0, 12)];
            }
        }
            ...
            for ($j = 0; $j < count($fogmap[$i]); $j++) {
                ...
                switch ($fogmap[$i][$j]) {
                    ...
                    case 'de2':
                        ...
                        break;
                    case 's1': ///////////////////////////////////////////////////////////////////////////////Pantano 2.1
                        echo "<img src='resources/biomes/s1.png' alt='swamp' class='biome' />";
                        break;
                    case 's2':
                        echo "<img src='resources/biomes/s2.png' alt='swamp' class='biome' />";
                        break;
                    case 'D': ///////////////////////////////////////////////////////////////////////////////Castillo
                    ...
                    case 'C': ///////////////////////////////////////////////////////////////////////////////Cueva
                        ...
                        break;
                    case 'H': ///////////////////////////////////////////////////////////////////////////////Portal
                        echo "<img src='resources/biomes/h1.png' alt='cave' class='biome' />";
                        break;
                    case 'V': ///////////////////////////////////////////////////////////////////////////////Pueblo
    ...
    public static function typingText(): string
    {
        ...
        switch ($fogmap[$character->getY()][$character->getX()]) {
            ...
            case 's1': ///////////////////////////////////////////////////////////////////////////////Pantano 2.1
            case 's2':
                if (rand(1, 100) <= 70 && !$_SESSION['escape']) {
                    $log = "The air grows heavy <br/>with the stench of decay... <br/>something stirs<br/>in the murky water.";
                    $_SESSION['encounter'] = true;
                    $_SESSION['buttonYes'] = false;
                    $_SESSION['dungeon'] = false;
                } else {
                    $log = "The swamp is eerily quiet, <br/>shrouded in mist... the <br/>darkness feels alive.";
                    $_SESSION['encounter'] = false;
                    $_SESSION['buttonYes'] = false;
                    $_SESSION['dungeon'] = false;
                }
            ...
            case 'C': ///////////////////////////////////////////////////////////////////////////////Cueva
                ...
                break;
            case 'H': ///////////////////////////////////////////////////////////////////////////////Portal 2.1
                $log = "A dark portal crackles<br/> with ominous energy.<br/> Will you step through?";
                $_SESSION['dungeon'] = true;
                $_SESSION['encounter'] = false;
                break;
            case 'D': ///////////////////////////////////////////////////////////////////////////////Dungeon
    ...
    public static function gamebuttons()
    {
        ...
        if ($_SERVER["REQUEST_METHOD"] === "POST") { //Habra que manejarlos en index
            ...
            if (isset($_POST['save_game'])) { //Curarme usando pocion
                Db_controller::save_game($_SESSION['game']->getGameId());
            }
        }
    }
}

...
<body class="bodygame">
    ...
    } else { //Pruebas se sustituira por una conexion a la base de datos y luego manejamos con Session
                ...
                if (isset($_SESSION['encounter'])) {
                    if ($_SESSION['encounter'] == true) {
                        echo "<form action='#' method='post'>
                                    <button type='submit' class='button-combat' name='combat'>Combat</button>
                                </form>";
                    }
                }
